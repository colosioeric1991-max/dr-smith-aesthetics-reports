...
const imgPath = resolve(__dirname, 'carousel-images/holiday.png');
let imgBase64 = '';
try {
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .s1-bg img { width: 100%; height: 100%; object-fit: cover; object-position: 35% 30%; }
  .s1-wash {
  ...
  .s1-title {
    ...
    letter-spacing: -0.03em; color: var(--warm); margin-bottom: 30px;
  }
  .s1-title em { font-style: italic; font-weight: 400; color: rgba(201,169,110,0.95); }
  .s1-rule { width: 60px; height: 1px; background: rgba(201,169,110,0.5); margin-bottom: 30px; }
  .s1-sub {
...
<div class="slide active bg-teal" id="s1">
  <div class="s1-bg">
    ${imgBase64 ? `<img src="${imgBase64}" alt="Summer sun and skin" />` : ''}
  </div>
  <div class="s1-wash"></div>
  <div class="s1-text">
    <p class="eyebrow">Summer Planning · Dr Smith Aesthetics</p>
    <h1 class="s1-title">Before you <em>fly</em></h1>
    <div class="s1-rule"></div>
    <p class="s1-sub">The treatments to book, and the ones to avoid, before a summer holiday.</p>
  </div>
  <div class="progress"><div class="progress-fill" style="width:20%"></div></div>
  <div class="footer">
    <span class="f-left">Summer Skin · Planning</span>
...
<div class="slide bg-teal" id="s2">
  ...
  <div class="s2-content">
    <p class="eyebrow">Timing Is Everything</p>
    <h2 class="s2-headline">
      Booked the flights?<br>
      <em>Now book your skin in.</em>
    </h2>
    <div class="s2-rule"></div>
    <p class="s2-body">Some treatments love a two-week head start. Others don't mix with strong sun at all. Here's how to time your appointments so you land looking your best, not recovering.</p>
  </div>
...
<div class="slide bg-cream" id="s3">
  <div class="s3-content">
    <p class="eyebrow">Book These</p>
    <h2 class="s3-headline">Safe before you <em>fly</em></h2>
    <div class="s3-rule"></div>
    <div class="s3-items">
      <div class="s3-item">
        <div class="s3-num">01</div>
        <div>
          <p class="s3-label">Botox</p>
          <p class="s3-text">Ideally two weeks ahead, so results have settled and any tweaks are done.</p>
        </div>
      </div>
      <div class="s3-item">
        <div class="s3-num">02</div>
        <div>
          <p class="s3-label">Skin Boosters</p>
          <p class="s3-text">SkinVive or Sunekos two to three weeks ahead for peak glow on arrival.</p>
        </div>
      </div>
      <div class="s3-item">
        <div class="s3-num">03</div>
        <div>
          <p class="s3-label">Filler</p>
          <p class="s3-text">Allow two to four weeks for settling and for any bruising to fade fully.</p>
        </div>
      </div>
      <div class="s3-item">
        <div class="s3-num">04</div>
        <div>
          <p class="s3-label">A Skin Consultation</p>
          <p class="s3-text">Leave with a suitcase-ready routine and the right SPF for your skin.</p>
        </div>
      </div>
    </div>
  </div>
...
<!-- ══ SLIDE 4 : SAVE FOR AFTER ═══════════════════════════════ -->
<div class="slide bg-teal" id="s4">
  <div class="s4-glow"></div>
  <div class="s4-content">
    <p class="eyebrow">Save These for After</p>
    <h2 class="s4-headline">Not before the <em>sun</em></h2>
    <div class="s4-rule"></div>
    <div class="s4-items">
      <div class="s4-item">
        <div class="s4-num">01</div>
        <div>
          <p class="s4-label">Chemical Peels</p>
          <p class="s4-text">Freshly resurfaced skin and strong sun are a recipe for pigmentation.</p>
        </div>
      </div>
      <div class="s4-item">
        <div class="s4-num">02</div>
        <div>
          <p class="s4-label">Microneedling</p>
          <p class="s4-text">Give your skin at least two weeks before any heavy sun exposure.</p>
        </div>
      </div>
      <div class="s4-item">
        <div class="s4-num">03</div>
        <div>
          <p class="s4-label">Strong Actives</p>
          <p class="s4-text">Pause retinoids a few days before you go and while you're in the sun.</p>
        </div>
      </div>
      <div class="s4-item">
        <div class="s4-num">04</div>
        <div>
          <p class="s4-label">Last-Minute Anything</p>
          <p class="s4-text">Never try a brand-new treatment days before a big trip. Plan ahead instead.</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="slide bg-cream" id="s5">
  <div class="s5-content">
    <p class="eyebrow centered">Summer Planning</p>
    <h2 class="s5-headline">Flying soon?<br><em>Plan your skin first.</em></h2>
    <div class="s5-divider"></div>
    <p class="s5-sessions">Pre-holiday appointments available now</p>
...
const outputDir = resolve(__dirname, '../Carousels/Holiday-Carousel');
...
const slides = [
  ...
  { id: 's3', file: '03-book-these.png' },
  { id: 's4', file: '04-save-for-after.png' },
