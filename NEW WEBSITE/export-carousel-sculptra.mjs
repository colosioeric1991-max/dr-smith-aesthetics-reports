...
const imgPath = '/Users/leesmith/Downloads/Sculptra.png';
let imgBase64 = '';
try {
  const buf = await readFile(imgPath);
  imgBase64 = 'data:image/png;base64,' + buf.toString('base64');
} catch {
  console.log('⚠  Sculptra.png not found – slide 1 will show a placeholder');
}
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .s1-img-area {
    position: absolute;
    top: 310px; left: 0; right: 0; bottom: 270px;
  ...
  .s1-title {
    ...
    font-size: 5.0rem; font-weight: 300; line-height: 0.92;
    letter-spacing: -0.03em; color: var(--teal); margin-bottom: 14px;
  }
...
<div class="slide active bg-cream" id="s1">
  <div class="s1-img-area">
    ${imgBase64
      ? `<img class="s1-img" src="${imgBase64}" alt="Sculptra® by Galderma" />`
      : `<div class="s1-img-placeholder"><span>Sculptra® Product Image</span></div>`
    }
  </div>
  <div class="s1-text">
    <p class="eyebrow">New Treatment · Dr Smith Aesthetics</p>
    <h1 class="s1-title">Sculptra<sup>®</sup></h1>
    <p class="s1-sub">Now available at our Kennington clinic.</p>
  </div>
  <div class="progress"><div class="progress-fill" style="width:20%"></div></div>
  <div class="footer">
    <span class="f-left">Sculptra® · Biostimulator</span>
...
<div class="slide bg-teal" id="s2">
  ...
  <div class="s2-content">
    <p class="eyebrow">Introducing Sculptra®</p>
    <h2 class="s2-headline">
      Your skin stops making collagen<br>
      in your mid-twenties.<br>
      <em>Sculptra® wakes it back up.</em>
    </h2>
    <div class="s2-rule"></div>
    <p class="s2-body">Not by adding volume from the outside. By triggering your skin cells to produce collagen from within. Results build gradually, naturally, over weeks to months.</p>
  </div>
...
<div class="slide bg-cream" id="s3">
  <div class="s3-content">
    ...
    <h2 class="s3-headline">A <em>biostimulator,</em> not a filler</h2>
    <div class="s3-rule"></div>
    <div class="s3-items">
      <div class="s3-item">
        <div class="s3-num">01</div>
        <div>
          <p class="s3-label">Inject</p>
          <p class="s3-text">PLLA microspheres are injected into targeted areas of the face, including the cheeks, temples and jawline.</p>
        </div>
      </div>
      <div class="s3-item">
        ...
        <div>
          ...
          <p class="s3-text">Your body's natural repair response is triggered, stimulating the production of new collagen where it is needed.</p>
        </div>
      </div>
      <div class="s3-item">
        <div class="s3-num">03</div>
        <div>
          <p class="s3-label">Transform</p>
          <p class="s3-text">Volume and skin quality gradually restore over weeks to months. The results look like your own skin, because they are.</p>
        </div>
      </div>
      <div class="s3-item">
        <div class="s3-num">04</div>
        <div>
          <p class="s3-label">Why Sculptra®?</p>
          <p class="s3-text">Unlike fillers, results grow as your own collagen grows. They don't look done. They look like you, naturally refreshed.</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="slide bg-teal" id="s4">
  ...
  <div class="s4-content">
    ...
    <h2 class="s4-headline"><em>Gradual.</em> Natural. Long-lasting.</h2>
    <div class="s4-rule"></div>
    <div class="s4-items">
      <div class="s4-item">
        <div class="s4-num">01</div>
        <div>
          <p class="s4-label">Days 1–5</p>
          <p class="s4-text">Some swelling is expected and settles quickly. The PLLA is already at work beneath the surface.</p>
        </div>
      </div>
      <div class="s4-item">
        ...
        <div>
          ...
          <p class="s4-text">Collagen production begins. First subtle improvements in skin firmness and facial volume become visible.</p>
        </div>
      </div>
      <div class="s4-item">
        <div class="s4-num">03</div>
        <div>
          <p class="s4-label">Months 2–4</p>
          <p class="s4-text">Results continue to develop and improve as new collagen integrates. Skin quality and structure progressively improve.</p>
        </div>
      </div>
      <div class="s4-item">
        <div class="s4-num">04</div>
        <div>
          <p class="s4-label">Year 1–2+</p>
          <p class="s4-text">Full effect from the course. Results from 2-3 sessions can last 2 years or more, with maintenance available.</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="slide bg-cream" id="s5">
  <div class="s5-content">
    ...
    <h2 class="s5-headline">Sculptra<sup>®</sup> at<br><em>Dr Smith Aesthetics</em></h2>
    <div class="s5-divider"></div>
    <p class="s5-sessions">Course of 2–3 sessions · 1 hour per session</p>
...
const outputDir = resolve(__dirname, '../Carousels/Sculptra-Carousel');
