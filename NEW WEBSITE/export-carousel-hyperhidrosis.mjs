...
const imgPath = resolve(__dirname, 'carousel-images/hyperhidrosis.png');
let imgBase64 = '';
try {
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .s1-bg img { width: 100%; height: 100%; object-fit: cover; object-position: 50% 25%; }
  .s1-wash {
...
<div class="slide active bg-teal" id="s1">
  <div class="s1-bg">
    ${imgBase64 ? `<img src="${imgBase64}" alt="Fresh, dry summer skin" />` : ''}
  </div>
  <div class="s1-wash"></div>
  <div class="s1-text">
    <p class="eyebrow">Medical Botox · Dr Smith Aesthetics</p>
    <h1 class="s1-title">Hyperhidrosis</h1>
    <div class="s1-rule"></div>
    <p class="s1-sub">The doctor-led treatment for excessive sweating.</p>
  </div>
  <div class="progress"><div class="progress-fill" style="width:20%"></div></div>
  <div class="footer">
    <span class="f-left">Hyperhidrosis · Medical Botox</span>
...
<div class="slide bg-teal" id="s2">
  ...
  <div class="s2-content">
    <p class="eyebrow">Excessive Sweating</p>
    <h2 class="s2-headline">
      Sweating through<br>
      <em>every summer top?</em>
    </h2>
    <div class="s2-rule"></div>
    <p class="s2-body">Hyperhidrosis is a real medical condition, not a hygiene problem. When antiperspirants stop working, a course of tiny Botox injections can keep the treated area dry for months at a time.</p>
  </div>
  ...
  <div class="s3-content">
    ...
    <div class="s3-items">
      <div class="s3-item">
        ...
        <div>
          <p class="s3-label">The Signal</p>
          <p class="s3-text">Botox blocks the nerve signal that switches your sweat glands on.</p>
        </div>
      </div>
      <div class="s3-item">
        <div class="s3-num">02</div>
        <div>
          <p class="s3-label">The Injections</p>
          <p class="s3-text">A grid of tiny, shallow injections placed across the treated area.</p>
        </div>
      </div>
      <div class="s3-item">
        <div class="s3-num">03</div>
        <div>
          <p class="s3-label">The Areas</p>
          <p class="s3-text">Most commonly the underarms, where results are consistently excellent.</p>
        </div>
      </div>
      <div class="s3-item">
        <div class="s3-num">04</div>
        <div>
          <p class="s3-label">The Reduction</p>
          <p class="s3-text">Sweat production in the treated area falls dramatically, often by more than 80%.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="s4-items">
      <div class="s4-item">
        ...
        <div>
          ...
          <p class="s4-text">Around 30 minutes, with numbing options to keep it comfortable.</p>
        </div>
      </div>
      <div class="s4-item">
        ...
        <div>
          ...
          <p class="s4-text">None to speak of. You can go straight back to your day.</p>
        </div>
      </div>
      <div class="s4-item">
        <div class="s4-num">03</div>
        <div>
          <p class="s4-label">Going Dry</p>
          <p class="s4-text">Results begin within days and settle fully by two weeks.</p>
        </div>
      </div>
      <div class="s4-item">
        ...
        <div>
          ...
          <p class="s4-text">Typically around six months, and often longer than cosmetic Botox.</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="slide bg-cream" id="s5">
  <div class="s5-content">
    <p class="eyebrow centered">Medical Botox</p>
    <h2 class="s5-headline">Ready for a <em>dry</em><br>summer?</h2>
    <div class="s5-divider"></div>
    <p class="s5-sessions">Hyperhidrosis consultations available now</p>
...
const outputDir = resolve(__dirname, '../Carousels/Hyperhidrosis-Carousel');
