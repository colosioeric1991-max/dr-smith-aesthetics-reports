...
const imgPath = resolve(__dirname, 'carousel-images/masseter.png');
let imgBase64 = '';
try {
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Zoomed 15%, anchored top so the source's tight head crop reads as
     deliberate framing and the jawline sits near the vertical centre. */
  .s1-bg { position: absolute; inset: 0; }
  .s1-bg img {
    width: 100%; height: 100%; object-fit: cover; object-position: 68% 30%;
    transform: scale(1.15); transform-origin: 68% 0%;
  }
  .s1-wash {
...
<div class="slide active bg-teal" id="s1">
  <div class="s1-bg">
    ${imgBase64 ? `<img src="${imgBase64}" alt="Defined jawline" />` : ''}
  </div>
  <div class="s1-wash"></div>
  <div class="s1-text">
    <p class="eyebrow">Jawline &amp; Facial Balancing · Dr Smith Aesthetics</p>
    <h1 class="s1-title">Masseter <em>Botox</em></h1>
    <div class="s1-rule"></div>
    <p class="s1-sub">Jaw slimming. Relief from clenching and grinding. One treatment.</p>
  </div>
  <div class="progress"><div class="progress-fill" style="width:20%"></div></div>
  <div class="footer">
    <span class="f-left">Masseter Botox · Jawline</span>
...
<div class="slide bg-teal" id="s2">
  ...
  <div class="s2-content">
    <p class="eyebrow">The Overworked Jaw</p>
    <h2 class="s2-headline">
      Clenching all day.<br>
      <em>Grinding all night.</em>
    </h2>
    <div class="s2-rule"></div>
    <p class="s2-body">An overworked masseter muscle can cause jaw tension, headaches, worn teeth and a widening of the lower face. A few precise injections can quieten it, easing the symptoms and softening the jawline at the same time.</p>
  </div>
  ...
  <div class="s3-content">
    ...
    <div class="s3-items">
      <div class="s3-item">
        ...
        <div>
          <p class="s3-label">The Masseter</p>
          <p class="s3-text">The powerful chewing muscle at the angle of the jaw, and one of the strongest in the body.</p>
        </div>
      </div>
      <div class="s3-item">
        <div class="s3-num">02</div>
        <div>
          <p class="s3-label">Precise Relaxation</p>
          <p class="s3-text">Botox reduces the muscle's resting overactivity, easing clenching and grinding.</p>
        </div>
      </div>
      <div class="s3-item">
        <div class="s3-num">03</div>
        <div>
          <p class="s3-label">Facial Slimming</p>
          <p class="s3-text">With less workload, an enlarged masseter gradually softens and the lower face slims.</p>
        </div>
      </div>
      <div class="s3-item">
        <div class="s3-num">04</div>
        <div>
          <p class="s3-label">Doctor-Led Dosing</p>
          <p class="s3-text">Assessed and dosed by a doctor, so chewing and your natural smile are unaffected.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="s4-items">
      <div class="s4-item">
        ...
        <div>
          ...
          <p class="s4-text">A short visit, with a few small injections into each side of the jaw.</p>
        </div>
      </div>
      <div class="s4-item">
        <div class="s4-num">02</div>
        <div>
          <p class="s4-label">First Relief</p>
          <p class="s4-text">Clenching and tension usually begin to ease within the first two weeks.</p>
        </div>
      </div>
      <div class="s4-item">
        <div class="s4-num">03</div>
        <div>
          <p class="s4-label">The Jawline</p>
          <p class="s4-text">Slimming develops gradually over two to three months as the muscle rests.</p>
        </div>
      </div>
      <div class="s4-item">
        ...
        <div>
          ...
          <p class="s4-text">Typically four to six months, with results building over repeat treatments.</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="slide bg-cream" id="s5">
  <div class="s5-content">
    <p class="eyebrow centered">Jawline &amp; Facial Balancing</p>
    <h2 class="s5-headline">Ready to <em>unclench</em>?</h2>
    <div class="s5-divider"></div>
    <p class="s5-sessions">Masseter consultations available now</p>
...
const outputDir = resolve(__dirname, '../Carousels/Masseter-Carousel');
